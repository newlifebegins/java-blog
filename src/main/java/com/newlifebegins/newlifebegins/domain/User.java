package com.newlifebegins.newlifebegins.domain;
...
public class User implements UserDetails, Serializable {
    ...
    protected User() {  // 无参构造函数  设置为 protected 为了防止直接使用
    ...
    public String toString() {
        return String.format("User[id=%d,name='%s',username='%s',email='%s',password='%s',avatar='%s']",id,name,username,email,password,avatar);
    }
